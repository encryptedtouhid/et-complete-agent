...
using EncryptedTouhid.CompleteAgent.Host.Logging;
using EncryptedTouhid.CompleteAgent.Host.Models;
using EncryptedTouhid.CompleteAgent.Infrastructure.Logging;
...
internal static class AgentEndpoints
{
    public static IEndpointRouteBuilder MapAgentEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        var group = app.MapGroup("/agent")
            ...
            .RequireAuthorization(EncryptedTouhid.CompleteAgent.Host.Authentication.AuthenticationServiceCollectionExtensions.PolicyAgent);
